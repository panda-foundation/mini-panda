...
@test.values = local_unnamed_addr global [5 x i8] c"\01\02\03\04\05"
...
; Function Attrs: nofree nounwind
define void @test.call_print(%test.Data* nocapture %data) local_unnamed_addr #0 {
entry:
  %0 = getelementptr %test.Data, %test.Data* %data, i64 0, i32 0
...
; Function Attrs: nofree nounwind
define void @test.call_array(i8* nocapture %data) local_unnamed_addr #0 {
entry:
...
; Function Attrs: nofree nounwind
define void @test.extern() local_unnamed_addr #0 {
entry:
...
; Function Attrs: norecurse nounwind readnone
define i32 @test.add(i32 %a, i32 %b) local_unnamed_addr #1 {
entry:
  %0 = add i32 %b, %a
  ret i32 %0
}
...
; Function Attrs: nofree nounwind
define void @test.Data.print_integer(%test.Data* nocapture readonly %this) local_unnamed_addr #0 {
entry:
  %0 = getelementptr %test.Data, %test.Data* %this, i64 0, i32 0
