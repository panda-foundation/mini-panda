...
@test.global_array = local_unnamed_addr global [5 x i8] c"\01\02\03\04\05"
...
entry:
  ...
  %18 = load i8, i8* @test.Color.g, align 1
  %19 = sext i8 %18 to i32
  %20 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([14 x i8], [14 x i8]* @string.d18cb31ff3a37014a9ed64a2687344d4, i64 0, i64 0), i32 %19) #2
  %21 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([42 x i8], [42 x i8]* @string.b3d07c6ed065e98d1f68c8339262934b, i64 0, i64 0))
  ret void
}
...
entry:
  ...
  %14 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([41 x i8], [41 x i8]* @string.7075c7a2cf104c828efd167315b7d1b2, i64 0, i64 0))
  ret void
}
